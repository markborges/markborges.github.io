...
function addBCRepositoryInfo(data) {
    ...
    if (data.download_info) {
        ...
        bcr_header += bcr_separator + '<strong>Download</strong>: <a href="' + first_download[2] + '" onClick="ga(\'send\', \'event\', \'APPs\', \'Download\', this.href);">' + first_download[1] + '</a>' + downloadState(first_download[0]);
        bcr_separator = ' | ';
    }
