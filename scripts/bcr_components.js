...
function addBCRepositoryInfo(data) {
    ...
    if (data.download_info) {
        ...
        bcr_header += bcr_separator + '<strong>Download</strong>: <a href="' + first_download[2] + '" onclick=”_gaq.push([‘_trackEvent’,’Download’,’APP’,this.href]);”>' + first_download[1] + '</a>' + downloadState(first_download[0]);
        bcr_separator = ' | ';
    }
